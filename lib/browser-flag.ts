(function () {
	...
	let murmurhash3_32_gc = function(key: any, seed: any): any {
      var remainder: any, 
	  	  bytes: any, 
		  h1: any, 
		  h1b: any, 
	...
	class BrowerFlag {
        ...
        private _config = {
       	...
       	private _defaultSettings = <settingsInfo>{
			
        }
        
        private _setting: settingsInfo;
		...
		get (): string {
			return murmurhash3_32_gc('agrgyqyrqt252626', 31);
		}
